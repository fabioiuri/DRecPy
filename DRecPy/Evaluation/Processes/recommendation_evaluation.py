...
def recommendation_evaluation(model, ds_test=None, n_test_users=None, n_pos_interactions=None, k=10, novelty=False,
    ...
    for user in _iter:
        ...
        t = Thread(target=_recommendation_evaluation_user, args=(model, user, ds_test, interaction_threshold,
...
def _recommendation_evaluation_user(model, user, ds_test, interaction_threshold, n_pos_interactions, metrics,
    ...
    if len(user_interacted_items) == 0: return
